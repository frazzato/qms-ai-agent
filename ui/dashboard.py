...
""", unsafe_allow_html=True)
    ...
    st.markdown(f"""
<div class="hero-card">
<div class="hero-badge">🤖 AI-POWERED QMS ACTIVE</div>
<div class="hero-title">AS9100 Rev D with<br>AI-Assisted Modules</div>
<div class="hero-sub">
...
<div class="ai-grid">
<div class="ai-module">
<div class="ai-module-icon" style="background:rgba(59,130,246,0.12);">📋</div>
...
<div class="ai-module-icon" style="background:rgba(239,68,68,0.12);">🛠️</div>
<div class="ai-module-name">CAPA Generator</div>
<div class="ai-module-desc">Root cause analysis & corrective action reports</div>
</div>
<div class="ai-module">
<div class="ai-module-icon" style="background:rgba(34,197,94,0.12);">✅</div>
...
<div class="ai-module">
<div class="new-badge">NEW</div>
<div class="ai-module-icon" style="background:rgba(245,158,11,0.12);">⚠️</div>
<div class="ai-module-name">Risk Assessment</div>
<div class="ai-module-desc">Likelihood × severity matrix with mitigations</div>
</div>
<div class="ai-module">
<div class="ai-module-icon" style="background:rgba(139,92,246,0.12);">🎓</div>
...
<span style="font-size:0.85rem; font-weight:700; color:#e2e8f0;">SYSTEM HEALTH</span>
<span style="font-size:1.4rem; font-weight:800; color:{bar_color};">{health}%</span>
</div>
<span style="font-size:0.72rem; color:#475569;">Last AI Sync: {time.strftime('%Y-%m-%d %H:%M:%S')}</span>
</div>
<div class="health-bar-track">
<div class="health-bar-fill" style="width:{health}%; background:linear-gradient(90deg,{bar_color},#3b82f6);"></div>
</div>
</div>
""", unsafe_allow_html=True)
...
<span style="font-size:0.88rem; font-weight:600; color:#e2e8f0;">Gap Analysis Engine</span>
<span style="font-size:0.75rem; color:#22c55e; margin-left:auto;">Operational</span>
</div>
<div class="status-row">
<div class="pulse-dot"></div>
<span style="font-size:0.88rem; font-weight:600; color:#e2e8f0;">CAPA Generator</span>
<span style="font-size:0.75rem; color:#22c55e; margin-left:auto;">Operational</span>
</div>
<div class="status-row">
<div class="pulse-dot"></div>
<span style="font-size:0.88rem; font-weight:600; color:#e2e8f0;">Audit Checklist Builder</span>
<span style="font-size:0.75rem; color:#22c55e; margin-left:auto;">Operational</span>
</div>
<div class="status-row">
<div class="pulse-dot"></div>
<span style="font-size:0.88rem; font-weight:600; color:#e2e8f0;">Risk Assessment</span>
<span style="font-size:0.75rem; color:#22c55e; margin-left:auto;">Operational</span>
</div>
<div class="status-row">
<div class="pulse-dot"></div>
<span style="font-size:0.88rem; font-weight:600; color:#e2e8f0;">Training Module</span>
<span style="font-size:0.75rem; color:#22c55e; margin-left:auto;">Operational</span>
</div>
<div class="status-row">
<div class="pulse-dot"></div>
<span style="font-size:0.88rem; font-weight:600; color:#e2e8f0;">Document Sync</span>
<span style="font-size:0.75rem; color:#22c55e; margin-left:auto;">Synced · {total} docs</span>
</div>
</div>
""", unsafe_allow_html=True)
